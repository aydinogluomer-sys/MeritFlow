...
-- =============================================================================
-- Phase P2 / slice 1-A seed — Policy Health evaluations (DEV/STAGING ONLY)
-- Refs: implementation_product_9_modules §3.6. Deterministic policy_health_evaluations fixtures for
-- RLS / cross-tenant / immutability / same-org-FK / unique pgTAP (0045). Normally SERVER-ONLY writes
-- (service_role); here via the bypassrls migration role. GUARDED (to_regclass): the table is
-- introduced by the LATEST migration (0046); the N-1 upgrade drill runs this seed against the N-1
-- schema, so the block must no-op when absent. One evaluation per org for that org's published scoring
-- version (org A d2 / org B b-d2), rule_set_version 'health-v1'. Config-only fixture (no operational
-- data): gaming_resistance 84 (1 cliff), complexity 82 (static 32), other dimensions neutral 100 at
-- confidence 0 ⇒ transparent weighted overall 95 (3·100+2·100+2·84+2·100+1·100+1·82)/11. The engine's
-- values are unit-tested in TS; here they are a stored fixture (DB tests assert RLS/immutability/FK).
-- =============================================================================
do $$
begin
  if to_regclass('public.policy_health_evaluations') is not null then
    ...
    values
      ('a0000000-0000-0000-0000-0000000000eb', 'a0000000-0000-0000-0000-000000000001',
       'a0000000-0000-0000-0000-0000000000d2', 'health-v1', 95,
       '{"items":[{"dimension":"financial_integrity","score":100,"confidence":0,"drivers":[{"code":"POOL_CONSERVATION_BREACH","label":"Havuz korunum ihlali","impact":0,"value":0,"threshold":0},{"code":"MISSING_CAP_BASIS","label":"Eksik tavan tabanı","impact":0,"value":0,"threshold":0}],"evidence":[{"sourceType":"policy_version","sourceId":"a0000000-0000-0000-0000-0000000000d2"}]},{"dimension":"payout_concentration","score":100,"confidence":0,"drivers":[{"code":"CONCENTRATION_TOP10_HIGH","label":"İlk %10 payı","impact":0,"value":0,"threshold":0.5},{"code":"GINI_HIGH","label":"Gini yoğunlaşması","impact":0,"value":0,"threshold":0.5},{"code":"MEAN_MEDIAN_DIVERGENCE","label":"Ortalama/medyan sapması","impact":0,"value":0,"threshold":0.4}],"evidence":[{"sourceType":"policy_version","sourceId":"a0000000-0000-0000-0000-0000000000d2"}]},{"dimension":"gaming_resistance","score":84,"confidence":1,"drivers":[{"code":"THRESHOLD_CLIFF","label":"Eşik uçurumları","impact":-16,"value":1,"threshold":0}],"evidence":[{"sourceType":"policy_version","sourceId":"a0000000-0000-0000-0000-0000000000d2"}]},{"dimension":"manager_discretion","score":100,"confidence":0,"drivers":[{"code":"OVERRIDE_SHARE_HIGH","label":"Manuel override payı","impact":0,"value":0,"threshold":0.15}],"evidence":[{"sourceType":"policy_version","sourceId":"a0000000-0000-0000-0000-0000000000d2"}]},{"dimension":"dispute_exposure","score":100,"confidence":0,"drivers":[{"code":"DISPUTE_RATE_HIGH","label":"İtiraz oranı","impact":0,"value":0,"threshold":0.05},{"code":"OPEN_DISPUTES","label":"Açık itirazlar","impact":0,"value":0,"threshold":0}],"evidence":[{"sourceType":"policy_version","sourceId":"a0000000-0000-0000-0000-0000000000d2"}]},{"dimension":"complexity","score":82,"confidence":1,"drivers":[{"code":"COMPLEXITY_DEBT","label":"Karmaşıklık borcu","impact":-18,"value":32,"threshold":20}],"evidence":[{"sourceType":"policy_version","sourceId":"a0000000-0000-0000-0000-0000000000d2"}]}],"weights":[{"dimension":"financial_integrity","weight":3},{"dimension":"payout_concentration","weight":2},{"dimension":"gaming_resistance","weight":2},{"dimension":"manager_discretion","weight":2},{"dimension":"dispute_exposure","weight":1},{"dimension":"complexity","weight":1}],"deferred":["opportunity_balance","controllability"]}'::jsonb),
      ('b0000000-0000-0000-0000-0000000000eb', 'b0000000-0000-0000-0000-000000000002',
       'b0000000-0000-0000-0000-0000000000d2', 'health-v1', 95,
       '{"items":[{"dimension":"financial_integrity","score":100,"confidence":0,"drivers":[{"code":"POOL_CONSERVATION_BREACH","label":"Havuz korunum ihlali","impact":0,"value":0,"threshold":0},{"code":"MISSING_CAP_BASIS","label":"Eksik tavan tabanı","impact":0,"value":0,"threshold":0}],"evidence":[{"sourceType":"policy_version","sourceId":"b0000000-0000-0000-0000-0000000000d2"}]},{"dimension":"payout_concentration","score":100,"confidence":0,"drivers":[{"code":"CONCENTRATION_TOP10_HIGH","label":"İlk %10 payı","impact":0,"value":0,"threshold":0.5},{"code":"GINI_HIGH","label":"Gini yoğunlaşması","impact":0,"value":0,"threshold":0.5},{"code":"MEAN_MEDIAN_DIVERGENCE","label":"Ortalama/medyan sapması","impact":0,"value":0,"threshold":0.4}],"evidence":[{"sourceType":"policy_version","sourceId":"b0000000-0000-0000-0000-0000000000d2"}]},{"dimension":"gaming_resistance","score":84,"confidence":1,"drivers":[{"code":"THRESHOLD_CLIFF","label":"Eşik uçurumları","impact":-16,"value":1,"threshold":0}],"evidence":[{"sourceType":"policy_version","sourceId":"b0000000-0000-0000-0000-0000000000d2"}]},{"dimension":"manager_discretion","score":100,"confidence":0,"drivers":[{"code":"OVERRIDE_SHARE_HIGH","label":"Manuel override payı","impact":0,"value":0,"threshold":0.15}],"evidence":[{"sourceType":"policy_version","sourceId":"b0000000-0000-0000-0000-0000000000d2"}]},{"dimension":"dispute_exposure","score":100,"confidence":0,"drivers":[{"code":"DISPUTE_RATE_HIGH","label":"İtiraz oranı","impact":0,"value":0,"threshold":0.05},{"code":"OPEN_DISPUTES","label":"Açık itirazlar","impact":0,"value":0,"threshold":0}],"evidence":[{"sourceType":"policy_version","sourceId":"b0000000-0000-0000-0000-0000000000d2"}]},{"dimension":"complexity","score":82,"confidence":1,"drivers":[{"code":"COMPLEXITY_DEBT","label":"Karmaşıklık borcu","impact":-18,"value":32,"threshold":20}],"evidence":[{"sourceType":"policy_version","sourceId":"b0000000-0000-0000-0000-0000000000d2"}]}],"weights":[{"dimension":"financial_integrity","weight":3},{"dimension":"payout_concentration","weight":2},{"dimension":"gaming_resistance","weight":2},{"dimension":"manager_discretion","weight":2},{"dimension":"dispute_exposure","weight":1},{"dimension":"complexity","weight":1}],"deferred":["opportunity_balance","controllability"]}'::jsonb)
    on conflict (id) do nothing;
  end if;
end $$;
