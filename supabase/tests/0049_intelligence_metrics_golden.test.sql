-- =============================================================================
-- pgTAP — Phase P4 / slice 8-A2: END-TO-END GOLDEN for the deterministic metric layer (Module 8).
-- Run: supabase test db   (dev/staging local; never production)
-- Refs: §10.6 (cap — HR/policy audience), §10.11 (semantic query service), §10.21 (tests), §26, SI-12.
...
values ('d0000000-0000-0000-0000-0000000000f1', 'd0000000-0000-0000-0000-000000000004', 'Golden Team', 'd0000000-0000-0000-0000-0000000000d4');
...
insert into public.team_memberships (organization_id, team_id, profile_id, role_in_team, is_primary) values
  ...
  ('d0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-0000000000f1', 'd0000000-0000-0000-0000-0000000000d6', 'member', true);
...
values
  ('d0000000-0000-0000-0000-000000000041', 'd0000000-0000-0000-0000-000000000004', 'd0000000-0000-0000-0000-0000000000fc',
   ...
   1000, 6000000, 6000000, 6000000, 'yes', 'calculated'),
