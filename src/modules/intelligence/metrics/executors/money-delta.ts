...
// The 0051 view is now in database.generated.ts, so this uses the TYPED client with a literal select
// (no cast) — the Slice-1 type-drift bridge was removed in the card-wiring slice.
// ---------------------------------------------------------------------------
