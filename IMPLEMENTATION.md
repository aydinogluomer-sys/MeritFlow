...
> Son güncelleme: 2026-09-12 (Phase P1 4-C policy debt UI — plan §6.10 / §18 UX; APP-LAYER ONLY, no migration/DB change/new permission; advisory-only §26 (no auto-apply); server-side authz + `policy_debt` flag on every surface; verify:fast + verify:contracts green; base origin/main w/ 4-B merged. Concludes Module 4 & Phase P1).
