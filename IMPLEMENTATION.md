...
> Son güncelleme: 2026-09-08 (Phase P1 6-C policy change impact UI — plan §8.9/§8.10/§18; app-layer only, no DB change; list+detail+CTAs, flag-gated nav; verify:fast + verify:contracts green; base origin/main w/ 6-B merged).
