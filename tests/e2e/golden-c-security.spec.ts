...
// ENGINEERING-27: derive the offset from the CI run number, NOT the wall clock — deterministic
// within a run (reproducible on re-run) and unique across runs. `Date.now() % 300` was not reproducible.
